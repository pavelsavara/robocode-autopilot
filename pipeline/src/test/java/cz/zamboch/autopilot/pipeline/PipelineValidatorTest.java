...
class PipelineValidatorTest {
    ...
    void energyAccounting_noEvent_noDiscrepancy() {
        ...
        validator.accountEnergy(0, turn.getRobots(), turn.getBullets(), turn);
    ...
    void energyAccounting_fireReducesEnergy() {
        ...
        validator.accountEnergy(0, t1.getRobots(), t1.getBullets(), t1);
        ...
        validator.accountEnergy(0, t2.getRobots(), t2.getBullets(), t2);
    ...
    void assertNonVacuous_throwsForEmptyLayer1() {
        ...
        validator.accountEnergy(0, t.getRobots(), t.getBullets(), t);
        validator.accountEnergy(0, t.getRobots(), t.getBullets(), t);
