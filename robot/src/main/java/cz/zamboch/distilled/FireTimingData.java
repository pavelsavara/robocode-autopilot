...
/**
 * Auto-generated data loader for the fire_timing GBM model.
 * Loads variable-length tree arrays from the binary resource file.
 *
 * <p>Model: 200 trees, 22,458 total nodes, 1 class(es),
...
public final class FireTimingData {
    ...
    public static final String[] FEATURE_NAMES = {
        "distance", "bearing_to_opponent_abs", "opponent_dist_to_wall_min", "our_gun_heat", "ticks_since_scan", "opponent_energy", "our_x", "our_y", "our_heading", "our_velocity", "opponent_x", "opponent_y", "opponent_heading", "cumulative_damage_dealt", "cumulative_damage_received", "cumulative_our_hit_rate", "cumulative_opponent_hit_rate", "cumulative_our_shots_fired", "cumulative_opponent_shots_detected", "opponent_center_distance", "opponent_corner_proximity", "opponent_velocity", "opponent_lateral_velocity", "opponent_advancing_velocity", "opponent_heading_delta", "energy_ratio", "our_lateral_velocity", "our_dist_to_wall_min", "our_bullet_speed", "our_bullet_travel_time", "mea_for_our_bullet", "ticks_since_we_fired", "opponent_wall_ahead_distance", "n_our_waves_in_flight", "nearest_our_wave_gap", "envelope_fill_ratio", "reachable_distance_min", "reachable_distance_max", "reachable_gf_range", "opponent_lateral_direction", "opponent_velocity_delta", "opponent_is_decelerating", "opponent_time_since_direction_change", "opponent_angular_velocity", "opponent_max_turn_rate", "distance_norm", "linear_target_angle", "linear_target_offset", "circular_target_angle", "circular_target_offset", "gf_bearing_offset", "gf_current_at_power_1", "gf_current_at_power_1_5", "gf_current_at_power_2", "opponent_guess_factor", "opponent_avg_lateral_velocity_10", "opponent_avg_lateral_velocity_30", "opponent_heading_delta_variability_10", "opponent_velocity_variability_10", "opponent_time_since_velocity_change", "opponent_distance_since_direction_change", "distance_wmean", "distance_wstd", "bearing_to_opponent_abs_wmean", "bearing_to_opponent_abs_wstd", "opponent_dist_to_wall_min_wmean", "opponent_dist_to_wall_min_wstd", "our_gun_heat_wmean", "our_gun_heat_wstd", "ticks_since_scan_wmean", "ticks_since_scan_wstd", "opponent_energy_wmean", "opponent_energy_wstd", "our_x_wmean", "our_x_wstd", "our_y_wmean", "our_y_wstd", "our_heading_wmean", "our_heading_wstd", "our_velocity_wmean", "our_velocity_wstd"
    };
    ...
    public static GbmTreeEnsemble load() {
        try {
            InputStream is = FireTimingData.class.getResourceAsStream(
                    "/fire-timing.bin");
            if (is == null) {
                throw new RuntimeException("fire-timing.bin not found in JAR");
            }
            ...
            throw new RuntimeException("Failed to load fire_timing model", e);
        }
    }
}
